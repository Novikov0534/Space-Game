...
/// <summary>
/// Система ИИ для врагов - зрение, преследование и патрулирование
/// </summary>
public class Enemy_View : MonoBehaviour, IEnemyAI
{
    ...
    private void Update()
    {
        ...
        if (!facingRight && agent.velocity.x < -0.1f)
        {
            Flip();
        }
        else if (facingRight && agent.velocity.x > 0.1f)
        {
            Flip();
        }
    }
